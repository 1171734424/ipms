...
public class HotelAutoSevenTask extends ScheduledTask implements ProjectName {

	private final Logger logger = Logger.getLogger(HotelAutoSevenTask.class);
	...
	public HotelAutoSevenTask(String name) {
		super(name);
	}
