...
public class Campaign implements java.io.Serializable {
	...
	/** minimal constructor */
	public Campaign(String dataId, String campaignName, String campaignType, String campaignDesc, String usingRange,
			String usingPerson, String usingType, Date startTime, Date endTime, String businessId, String recordUser,
	...
	/** full constructor */
	public Campaign(String dataId, String campaignName, String campaignType, String campaignDesc, String usingRange,
			String usingPerson, String usingType, Date startTime, Date endTime, String campaignCycle,
			String businessId, Date recordTime, String recordUser, String priority, Double couponPrice,
			String couponGroupId, Double operMoney, String operType, String operScore, String roomCount, String gift,
			String goodsService, String experienceCount, String branchId, String roomType, String discount,
			Double discountPrice, String liveDay, String currentDay, String dayCount, String remark, String status,
			Date startShowTime, Date endShowTime, String roomId) {
		this.dataId = dataId;
		this.campaignName = campaignName;
		this.campaignType = campaignType;
		this.campaignDesc = campaignDesc;
	...
	@Column(name = "USING_RANGE", nullable = false, length = 7)
	...
	@Column(name = "USING_PERSON", nullable = false, length = 14)
	...
	@Temporal(TemporalType.TIMESTAMP)
	@DateTimeFormat(pattern = "yyyy/MM/dd HH:mm:ss")
	@Column(name = "START_SHOWTIME", nullable = true)
	...
	@Temporal(TemporalType.TIMESTAMP)
	@DateTimeFormat(pattern = "yyyy/MM/dd HH:mm:ss")
	@Column(name = "END_SHOWTIME", nullable = true)
