  ...
  <body>
   	   <div class="house_info workaccount_info">
			<form action="" method="post" id="haltplan_submit">
				<div class="">
					<ul class="clearfix">
						<li><label class="label_name">房间号码</label><input spellcheck="false" name="roomId" type="text" id="roomId" class="adroom" value='<%=roomId%>'></li>
		...
		<script type="text/javascript">
			...
			function submithaltplan(){
				...
				$.ajax({
			         url: path + "/apartmentsubmithaltpan.do",
					 type: "post",
