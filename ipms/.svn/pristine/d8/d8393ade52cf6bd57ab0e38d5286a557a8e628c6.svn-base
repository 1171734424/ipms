...
@Entity
@Table(name = "TB_C_MEMBER", schema = "UCR_PMS")
public class Member implements java.io.Serializable {

	// Fields
	private static final long serialVersionUID = 873807013422128710L;
	private String openId;// 添加的微信公众号17.07.07
	private String wechatAppopenId;// 添加的微信小程序号18.06.07
	...
	/** minimal constructor */
	public Member(String memberId, String memberName, String loginName, String password, String memberRank,
	...
	@Column(name = "WECHATAPPOPENID", length = 28)
