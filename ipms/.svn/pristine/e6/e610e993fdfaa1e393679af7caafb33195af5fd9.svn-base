...
<!-- 						<li><label class="label_name">开始日期:</label> -->
...
<!-- 							<option value="7" selected>7</option>   远期房态筛选条件页面 -->
...
<!-- 						</li> -->
		...
		<script type="text/javascript">
			...
			laydate ({
			   	...
			   	,min: laydate.now(+1)
// 			    ,choose: function() {
// 					$("#forwardFrame").attr("src","forwardHouse.do?madate="+$("#mdate").val()+"&days="+$(".days").val());
//		        }  
			});
			laydate ({
			   	elem: '#edate'
...
//		        }  
			  ...
			  $(document).ready(function() {
				...
				$("#forwardFrame").attr("src","forwardHouse.do?madate="+ $("#mdate").val()+"&edate="+$("#edate").val());
			 });
