...
<html class="whitebg">
  ...
  <div class="register_margin"><!--
     ...
     <form action="" method="post" id="omemberadd" name="omemberadd">
	      <section class="register_one">
	        <ul class="clearfix">
              ...
              <li><label class="label_name red">身份证</label><input id="oidcard" name="oidcard" class="text_check" type="text"  maxlength="18"/></li>
	...
	<script src="<%=request.getContextPath()%>/script/ipmshotel/leftmenu/order/ordermemberadd.js"></script>
