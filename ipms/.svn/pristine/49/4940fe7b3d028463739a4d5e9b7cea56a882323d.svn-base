...
<html>
  ...
  <body >
	<div class="leftorder_margin" style="background: #EFF3F5;box-shadow: 1px 1px 8px rgba(0, 0, 0, .3);border-radius: 4px;overflow: hidden;z-index: 9999;">
		...
		<h3>无人看房</h3>
		<form id="pagerForm" name="pagerForm" action="queryApartSelfservice.do" method="post" target="reservedFrame">
			<div class="content_member">
				...
				<div class="content_member_show" style="width: 100%; height:97%;">
					<iframe name="reservedFrame" id="reservedFrame" frameborder="0" width="100%" height="100%" src="queryApartSelfservice.do"></iframe>
				</div>
			</div>
		</form>
	</div>
	...
	<script type="text/javascript">
		...
		function osearchdata(){
			...
			var reservedTime = $("#reservedTime").val();
		 	$("#reservedFrame").attr("src","queryApartSelfservice.do.do?memberName="+memberName+"&mobile="+mobile+"&reservedTime="+reservedTime);
		}
