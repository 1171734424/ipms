...
.body_content{
  ...
  <div class='body_content'>
    ...
    <table class="branch_table crm-table">
    	...
    	<tr style="display: none;"><td class="must">等级</td><td><select class="inputStyle" id="branchRank" disabled="disabled">
    	...
    	<tr><td class="must">手机</td><td><input class="inputStyle" id="phone" value="${branch.mobile}"/></td><td class="must">座机</td><td><input class="inputStyle" id="homePhone" value="${branch.phone}" placeholder="如 0252554235"/></td></tr>
...
<!--     														</td> -->
    														...
    														<tr><td class="must">详细地址</td><td><input class="inputStyle" id="preLocation" value="${addresshead}"/></td></tr>
    	<tr><td valign="top"><label>备注</label></td><td colspan="3"><textarea class="inputStyle" id="remarkInput" >${branch.remark}</textarea></td></tr>
    </table>
