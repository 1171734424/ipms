...
import com.ideassoft.core.controller.PageController;
...
public class HouseRoomController {
	...
	private static Logger logger = Logger.getLogger(HouseRoomController.class);
	...
	@RequestMapping("/queryRoomListInHouse.do")
	public void queryRoomListInHouse(HttpServletRequest request, HttpServletResponse response, String roomtype,
...
//		roomdata.put("totallive", totallive);
	...
	@RequestMapping("/showgetcontinueinhouse.do")
	public ModelAndView showGetContinue(HttpServletRequest request) {
		...
		mv.setViewName("/page/ipmshouse/room_statistics/getcontinue");
		return mv;
	}
//	
//	@RequestMapping("/showresetpriceinhouse.do")
...
//		ModelAndView mv = new ModelAndView();
//		mv.addObject("checkid", checkid);
//		mv.setViewName("/page/ipmshouse/room_statistics/resetroomprice");
//		return mv;
//	}
//
//	@RequestMapping("/showtransferorderinhouse.do")
//	public ModelAndView orderSerach(HttpServletRequest request) throws Exception {
//		ModelAndView mv = new ModelAndView();
//		mv.setViewName("/page/ipmshouse/room_statistics/transferorder");
//		return mv;
//	}
//
//	@RequestMapping("/showTransferBillinhouse.do")
//	public ModelAndView showTransferBill(HttpServletRequest request) {
//		String checkid = request.getParameter("checkid");
//		ModelAndView mv = new ModelAndView();
//		mv.addObject("checkid", checkid);
//		mv.setViewName("/page/ipmshouse/room_statistics/transfer");
//		return mv;
//	}
//
//	@RequestMapping("/showgetAvailableRoomInHouse.do")
//	public ModelAndView showgetAvailableRoom(HttpServletRequest request) {
//		String checkid = request.getParameter("checkid");
//		ModelAndView mv = new ModelAndView();
//		mv.addObject("checkid", checkid);
//		mv.setViewName("/page/ipmshouse/room_statistics/AvailableRoom");
//		return mv;
//	}
//
//	@RequestMapping("/showgetAddBillInHouse.do")
//	public ModelAndView showgetAddBill(HttpServletRequest request) {
//		String checkid = request.getParameter("checkid");
//		ModelAndView mv = new ModelAndView();
//		mv.addObject("checkid", checkid);
//		mv.setViewName("/page/ipmshouse/room_statistics/add_bill");
//		return mv;
//	}
//
//	@RequestMapping("/showgetAddWorkBillinhouse.do")
...
//		mv.setViewName("/page/ipmshouse/work_account/add_workbill");
//		return mv;
//	}
//
//	@RequestMapping("/showupdateRoomPriceInHouse.do")
//	public ModelAndView showupdateRoomPrice(HttpServletRequest request) {
//		String checkid = request.getParameter("checkid");
//		ModelAndView mv = new ModelAndView();
//		mv.addObject("checkid", checkid);
//		mv.setViewName("/page/ipmshouse/room_statistics/update_roomprice");
//		return mv;
//	}
//
...
////		ModelAndView mv = new ModelAndView();
////		mv.addObject("checkid", checkid);
////		mv.setViewName("/page/ipmshouse/order/addPromptRecord");
////		return mv;
////	}
////	
...
////		ModelAndView mv = new ModelAndView();
////		mv.addObject("checkid", checkid);
////		mv.setViewName("/page/ipmshouse/order/addOrderPrompt");
////		return mv;
////	}
//
//	@RequestMapping("/showroommapinhouse.do")
...
//		mv.setViewName("/page/ipmshouse/room_statistics/roommap");
//		return mv;
//	}
//	
//	@RequestMapping("/showconsumptioninhouse.do")
...
//		mv.setViewName("/page/ipmshouse/room_statistics/consumption");
//		return mv;
//	}
//
//	@RequestMapping("/showroomlistcheckdatainhouse.do")
...
//		mv.setViewName("/page/ipmshouse/room_statistics/roomlistCheckData");
//		return mv;
//	}
//	
...
////		mv.setViewName("/page/ipmshouse/room_statistics/chummageplanData");
////		return mv;
////	}
//
//	@RequestMapping("/showupdateMemberinhouse.do")
...
//		mv.setViewName("/page/ipmshouse/room_statistics/updatemember");
//		return mv;
//	}
//
//	// 展示页面
//
//	@RequestMapping("/loadCheckDatainhouse.do")
...
//	}
//
//	@RequestMapping("/loadRoomBillDatainhouse.do.do")
...
//	}
//
//	@RequestMapping("/addworkbillinhouse.do")
...
//
//	// 房单日志
//	@RequestMapping("/showLogDatainhouse.do")
...
//			mv.addObject("checkid", checkid);
//			mv.addObject("pagination", pagination);
//			mv.setViewName("page/ipmshouse/order/orderPrompt");
//			return mv;
//		} else {
//			sql = "loadorderprompt";
//			List<Tips> result = roomService.findBySQLWithPagination(sql, new String[] { checkid }, pagination, true);
...
//			mv.addObject("checkid", checkid);
//			mv.addObject("pagination", pagination);
//			mv.setViewName("page/ipmshouse/order/prompt");
//			return mv;
//		}
//	}
//
...
//	}
//
//	@RequestMapping("/transferbillinhouse.do")
...
//	}
//	
//	@RequestMapping("/getBranchIdInHouse.do")
...
//	}
//
	@RequestMapping("/setRoomStatusInHouse.do")
...
//		mv.setViewName("page/ipmshouse/room_statistics/current_room");
//		return mv;
//	}
//
//	@SuppressWarnings("unchecked")
...
//		mv.setViewName("page/ipmshouse/room_statistics/pagecampaign");
//		return mv;
//	}
//
//	@SuppressWarnings("unchecked")
...
//		mv.setViewName("page/ipmshouse/room_statistics/forward_room");
//		return mv;
//	}
//
//	@RequestMapping("/checkoutbillinhouse.do")
...
//	}
//	
//	@RequestMapping("/partcheckoutbillinhouse.do")
...
//	}
//	
//	@RequestMapping("/allcheckoutbillinhouse.do")
...
//
//
//	@RequestMapping("/consumptioninhouse.do")
//	@RightMethodControl( rightType = RightConstants.RightType.CON_BILL )
...
////	}
//
//	@RequestMapping("/selectroommappinginhouse.do")
...
//	}
//	
//	@RequestMapping("/sethousecheckuserinhouse.do")
//	public void sethousecheckuserinhouse(HttpServletRequest request, HttpServletResponse response, String checkuserId, 
...
//	}
//
//	@RequestMapping("/autosaveRemarkinhouse.do")
...
//	}
//
//	@RequestMapping("/loadsinglehaltplaninhouse.do")
...
//		mv.addObject("pagination", pagination);
//		mv.setViewName("page/ipmshouse/order/prompt_details");
//		return mv;
//	}
//
//	// 统计提示信息日志未阅读数量
...
//	}
//	
	@RequestMapping("/getLogIdByRoomInHouse.do")
	public void getLogIdByRoomInHouse(HttpServletRequest request, HttpServletResponse response, String roomId) {
		LoginUser loginUser = (LoginUser) request.getSession(true).getAttribute(RequestUtil.LOGIN_USER_SESSION_KEY);
		String branchId = loginUser.getStaff().getBranchId();
...
//		ModelAndView mv = new ModelAndView();
//		mv.setViewName("page/ipmshouse/leftmenu/houserefund/reWriteRemarkH");
...
//		}
//		mv.setViewName("/page/ipmshouse/room_statistics/splitaccount");
//		return mv;
//	}
//	
//	/**
