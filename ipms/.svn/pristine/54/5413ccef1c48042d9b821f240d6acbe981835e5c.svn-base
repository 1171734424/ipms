  ...
  <body>
				...
				<tbody id="info">
					<c:forEach items="${list}" var="list">
						<tr>
							...
							<td>${list["CASHBACK"] }</td>
							<td><fmt:formatNumber type="number" value="${list['ROOMPRICE'] + list['CASHBACK']}" maxFractionDigits="2"/></td>
	...
	<script>
		...
		function bb(e) {
			...
			window.parent.parent.JDialog.openWithNoTitle("", path + "/page/ipmshotel/room_statistics/roomlist_check.jsp?checkid=" + checkid,1179,733);
