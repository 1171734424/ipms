     ...
     <form action="" method="post" id="omemberadd" name="omemberadd">
	      <section class="register_one" style="padding-top:6px; ">
	        <ul class="clearfix">
			  ...
			  <li style="padding-top:5px;"><label>房价</label><input id="amount" name="amount" style="width: 325px;height: 35px;vertical-align:top;"value="0.00" class="input_ms"  type="number" ></input></li>
