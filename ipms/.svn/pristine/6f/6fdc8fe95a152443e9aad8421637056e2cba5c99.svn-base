  ...
  <body>
	...
	<script>
		...
		function bb(e) {
			...
			window.parent.parent.JDialog.openWithNoTitle("", path + "/page/ipmspage/room_statistics/roomlist_check.jsp?checkid=" + checkid + "&pagea=" + "-1",1179,733);
