			...
			<div class="high_header">
				<!--  <i class="imooc detail_imooc" style="color:#3B3E40;"></i>	-->
					<div class="margintop">
						<form id="bill_date">
							<ul class="clearfix">
						      <li><label class="label_name">房单号：</label><input name="checkId" type="text"  id="checkId" class="text_edit" style="width: 188px;" readonly></li>
						      <li style="display:none;"><label class="label_name">日租：</label><input id="roomprice" name="roomprice" type="text" class="text_number" readonly></li>
						      <li><label class="label_name">账面金额：</label><input id="accountfee" name="accountfee" type="text" class="text_number" style="width: 188px;" readonly></li>
...
<!-- 						      <hr style="height:1px;border:0px;background-color:#D5D5D5;color:#D5D5D5;width:90%;"/> -->
		...
		<script type="text/javascript">
			...
			function loadCheckData(){
				$.ajax({
			         url: path + "/loadHouseCheckData.do",
					 type: "post",
					 data : {checkid : checkid},
					 success: function(json) {
						console.log(json)
					 	$("#roomprice").val(json.roomPrice);
					 },
					 error: function(json) {}
				});
			}
