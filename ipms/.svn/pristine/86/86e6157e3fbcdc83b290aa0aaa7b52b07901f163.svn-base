...
public class SystemConstants {
	...
	public interface LogModule {
		...
		final public static String DOORCARDADD = "cardAdd";
		final public static String DOORCARDDEL = "cardDel";
		final public static String DOORCARDDELALL = "allCardDel";
		final public static String MUTILDOORCARDADD = "IdToMtDoor";
	}
