...
<html>
   ...
   <body oncontextmenu="return false;" ondragstart="return false;" onselectstart="return false;">
		<div class="title main_one">
			<div class="design-img sys_icon">
				<img src="<%=request.getContextPath()%>/css/ipms/img/backgroundimg/logo.png" alt="系统logo"/>
				<span class="chtitle">基础资料管理系统</span>
			</div>
		...
		<div class="user active">
              ...
              <div class="user_panel" style="display:none;">
                  <ul class="user_opt"><!--
                      <li>
                          <a href="javascript:;">
                      ...
                      <li>
                          <a href="#" id="changerole" onclick="changeRole();">
                              <i class="fa fa-exchange"></i>
                              <span class="opt_name">切换帐号</span>
                          </a>
                      </li>
                       <!--<li class="pf-logout" >
                          <a href="#" id="loginout" onclick="loginOut();">
		...
		<script type="text/javascript">
			$(".main").css("height", $("body").outerHeight() - 70);
