		...
		function setroommap(){
			...
			$.ajax({
				 ...
				 success: function(json) {
				 	if(json.result == 1){
				 		//loadroommapping();
				 		window.parent.document.getElementById("customer").innerHTML='<iframe src="' + path +'/page/ipmspage/room_statistics/customer.jsp?checkid=' + hostcheckid +'" width="100%" height="100%" frameborder=no  scrolling="no"></iframe>'
