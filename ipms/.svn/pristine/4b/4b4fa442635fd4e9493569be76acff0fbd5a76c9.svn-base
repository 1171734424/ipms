...
<html>
  ...
  <div class="member_padding">
     ...
     <iframe name="" id="msIframe" frameborder="0" width="100%" height="100%" src="hotelmemberSearchdata.do" style="height: 81.5%"></iframe>
 </div>
	...
	<script src="<%=request.getContextPath()%>/script/ipmshotel/leftmenu/membersearch/membersearch.js"></script>
