  ...
  <body>
    <div class="bill_width">
			...
			<div class="foot_submit">
				...
				<span class="button_margin" onclick="printinvoice()">发票</span>
				<span class="button_margin" onclick="printbill()">打印</span>
		...
		var billCheck = true;
			...
			function checkout(freshtype){
				...
				if(passcheckroomlistbill())
					return false;
				var strbillid = getstrbillids();
				JDialog.open("退房", path + "/page/ipmspage/room_statistics/checkout.jsp?checkid=" + checkid + "&strbillids=" + strbillid + "&freshtype=" + freshtype + "&page=" + pagea, 700, 520);
			}
