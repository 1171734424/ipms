...
<html>
  ...
  <style>
	...
	.div_table .setparam .param-setting{
	width:90%;
	}
	.branchName{
	width: 77px;
  ...
  <body> 
     <div class="fadeInDown box-transition">
	  	<div class="div_table">
	  		<div class="setparam">
	  			<div class="param-setting">参数设置</div>
	  		 	<div class="query_con">
	  			<input class="branchName" id="branchName" type="text" placeholder="门店名称"/>
	  			<button class="queryBtn" onclick="queryParam()">查询</button>
	  			</div> 
	...
	<script src="<%=request.getContextPath()%>/script/crm/parameter/apartmentParam.js"></script>
