...
<html style="width:100%; height:100%;">
	...
	<body style="width:100%; height:100%;margin:0;padding:0;">
		...
		<input type="hidden" name="branchrank" id="branchrank" value='${branchrank}'/>
		...
		<script>
			...
			var quickAddCol = '${quickAddCol}';
			var showType = '<%=showType%>';
			$(document).ready(function(){
			var branchrank = $("#branchrank").val();
			$(".reportform_condition").find("li").removeClass("conditionNoshow");
			//if(branchrank=="0"){
			//  $(".reportform_condition").find("li").removeClass("conditionNoshow");
			//}
			})
