...
@Service
public class ApartmentWorkBillService extends GenericDAOImpl {
	
	
	// 工作账日志
		public List<?> apartmentgetworkbillLog(String workbillid, Pagination paginatin) {
	...
	public void apartmentupdateworkbill(String name, String describe, String workbillId) {
