  ...
  <body>
		...
		<script type="text/javascript">
			...
			function getworkbillinfo(){
				$.ajax({
			         url: path + "/apartmentgetworkbillinfo.do",
					 type: "post",
			...
			function updatework(){
				...
				$.ajax({
			         url: path + "/apartmentupdateworkbill.do",
					 type: "post",
					 data : {
					 	describe : describe,
					 	name : name,
			...
			/*账单*/
			function changetwo() {
				document.getElementById("a").innerHTML = '<iframe src="<%=request.getContextPath()%>/page/apartment/apartmentmainmenu/apartmentworkbill/work_bill.jsp?workbillid=' + workbillid + '" width="100%" height="100%" frameborder=no  scrolling="no"></iframe>'
			}
			/*日志*/
			function changefive() {
				document.getElementById("d").innerHTML = '<iframe src="' + path +'/page/apartment/apartmentmainmenu/apartmentworkbill/log.jsp?type=workbill&checkid='+ workbillid + '" width="100%" height="100%" frameborder=no  scrolling="no"></iframe>'
