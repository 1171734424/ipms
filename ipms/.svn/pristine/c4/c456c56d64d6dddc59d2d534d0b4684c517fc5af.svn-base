  ...
  <body style="overflow: hidden;">
		...
		<div class="shop_content  margin_gdspage">
			...
			<div class="shop_search" style="height:100%;">
				<form action="" method="post" style="height:100%;">
					...
					<iframe name="goodsIframe" id="goodsIframe" frameborder="0" width="100%" height="100%" src="gdsaleConditionInHouse.do" class="gpageiframe"></iframe>
					</div>
				</form>
			</div>
		</div>
	<div id="pager"></div>
		...
		function gdsearch(){
		 ...
		 $("#goodsIframe").attr("src","gdsaleConditionInHouse.do?goodsid="+goodsid+"&goodsname="+goodsname+"&categoryid="+categoryid+"&gdscontent="+gdscontent);
		}
