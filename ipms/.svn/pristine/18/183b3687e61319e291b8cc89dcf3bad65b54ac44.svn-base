			/*客单*/
			function changeone(){
				document.getElementById("customer").innerHTML='<iframe src="' + base_path +'/page/ipmshotel/room_statistics/customer.jsp?checkid=' + checkid +'" width="100%" height="100%" frameborder=no  scrolling="no"></iframe>'
				//console.log('<iframe src="' + base_path +'/page/ipmspage/room_statistics/customer.jsp?checkid=' + checkid +'"')
			}
			/*账单*/
			function changetwo(){
				document.getElementById("customer").innerHTML='<iframe src="' + base_path +'/page/ipmshotel/room_statistics/roomlist_bill.jsp?checkid=' + checkid + '&pagea=' + pagea + '" width="100%" height="100%" frameborder=no  scrolling="no"></iframe>'
			}
			/*房租计划*/
			function changethree(){
				document.getElementById("customer").innerHTML='<iframe src="' + base_path +'/page/ipmshotel/room_statistics/chummageplan.jsp" width="100%" height="100%" frameborder=no  scrolling="no"></iframe>'
			}
			/*提示*/
			function changefour(){
				countPrompt();
			...
			/*财务计划*/
			function changesix(){
				document.getElementById("customer").innerHTML='<iframe src="' + base_path +'/page/ipmshotel/room_statistics/finance.jsp" width="100%" height="100%" frameborder=no  scrolling="no"></iframe>'
			}
