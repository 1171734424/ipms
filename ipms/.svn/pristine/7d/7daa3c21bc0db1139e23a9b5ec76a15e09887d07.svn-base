...
<html>
  ...
  <div class="member_padding">
     ...
     <iframe name="" id="msIframe" frameborder="0" width="100%" height="92%" src="leftmenuqueryMemberInfo.do"></iframe>
 </div>
	...
	<script src="<%=request.getContextPath()%>/script/ipmshotel/leftmenu/member/member.js"></script>
