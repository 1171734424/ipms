...
<html>
  ...
  <body>
   <div class="work_margin">
	...
	<section style="width: 100%;" class="box-content-section fl">
		<section class="box_content_widget fl">
			<div class="content" style="padding:10px;height:929px;">
				<iframe name="logFrame" id="logFrame" frameborder="0" width="100%" height="100%" src="<%=request.getContextPath()%>/apartmentshowworkaccountdetail.do"></iframe>
	...
	<script src="<%=request.getContextPath()%>/script/apartment/apartmentLeftmenu/apartmentrefund/util.js"></script>
	...
	<script type="text/javascript">
		...
		function queryworkbillbystatus(status){
			...
			$("#logFrame").attr("src","<%=request.getContextPath()%>/apartmentshowworkaccountdetail.do?" + $("#workbill_search").serialize() );
		}
		...
		function bb(e) {
			...
			window.parent.parent.JDialog.openWithNoTitle("", path + "/page/apartment/apartmentmainmenu/apartmentworkbill/work_account_check.jsp?workbillid=" + workbillid,1180,738);
			//window.location.href="<%=request.getContextPath()%>/page/ipmspage/work_account/work_account_check.jsp";
		}
		$(".createaccount").on("click",function(){
			window.parent.parent.JDialog.open("创建工作账", path + "/page/apartment/apartmentmainmenu/apartmentworkbill/creatework_account.jsp" ,620,289);
		});
	</script>
  </body>
</html>
