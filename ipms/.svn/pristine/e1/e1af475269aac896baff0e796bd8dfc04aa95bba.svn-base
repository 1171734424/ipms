  ...
  <body>
	...
	<script>
		...
		function showstophaltplan(e){
			...
			window.JDialog.open("停售房编辑", path + "/page/apartment/apartmentmainmenu/apartmentstopselling/stophouse_edit.jsp?logid=" + logid + "&startTime=" +startTime + "&endTime=" + endTime, 882,512);
		}
		...
		function cancelhaltplan(logid){
			$.ajax({
		         url: path + "/apartmentcancelhaltplan.do",
				 type: "post",
				 data : {logid : logid},
