...
public class HotelAutoSixTask extends ScheduledTask implements ProjectName {

	private final Logger logger = Logger.getLogger(HotelAutoSixTask.class);
	...
	public HotelAutoSixTask(String name) {
		super(name);
	}
