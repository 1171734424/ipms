...
<!-- 			</li> -->
	...
	<script type="text/javascript">
		...
		function bb(e) {
			...
			window.parent.parent.JDialog.openWithNoTitle("", path + "/page/ipmshotel/work_account/work_account_check.jsp?workbillid=" + workbillid,1180,738);
			//window.location.href="<%=request.getContextPath()%>/page/ipmspage/work_account/work_account_check.jsp";
		}
		$(".createaccount").on("click",function(){
			window.parent.parent.JDialog.open("创建工作账", path + "/page/ipmshotel/work_account/creatework_account.jsp" ,620,289);
		});
	</script>
  </body>
</html>
