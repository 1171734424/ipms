...
<html>
  ...
  <body>
  	 <div class="integral_margin">
    	<div class="header_roomlist">
			...
			<div class="high_header inte-padding fadeInDown">
				...
				<form name="condition" id="condition" action="hotelLoginLog.do" method="post" target="logFrame">
		...
		<section class="box-content-section fl" style="width:100%;">
			<section class="box_content_widget fl">
				<div id="integral" class="content" style="height:889px;">
				 <c:if test="${param.type == '1'}">
					<iframe name="logFrame" id="logFrame" frameborder="0" width="100%" height="100%" src="hotelLoginLog.do?type=<%=request.getParameter("type")%>"></iframe>
				 </c:if>
				 <c:if test="${param.type == '2'}">
	...
	<script src="<%=request.getContextPath()%>/script/ipmshotel/hotelIntegral/integral.js"></script>
