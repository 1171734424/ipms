	...
	Msg: {
		...
		InitMsg : function(width) {
			var ifStr = '<iframe src="javascript:false" mce_src="javascript:false"' 
					...
					+ 'height:100%; z-index:-1;filter=\'progid:DXImageTransf	orm.Microsoft.Alpha(style=0,opacity=0)\';"></iframe>', 
					html = '<div class="top"><div class="right"><div class="title" id="dvMsgTitle"></div>'
						+ '</div></div><div class="body"><div class="right"><img class="img-tip" src="images/12.png"/><div class="ct" id="dvMsgCT"></div></div></div>'
