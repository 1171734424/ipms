		...
		outter: for (int i = rowPos; i <= rowNum; i++) {
			...
			if (row != null) {
				...
				if (bean != null) {
					...
					String floorId = (String) ReflectUtil.getValue(bean, "floorId");
					String roomId = (String) ReflectUtil.getValue(bean, "roomId");
					String equipDesc = (String) ReflectUtil.getValue(bean, "equipDesc");
					Date validStart = (Date)ReflectUtil.getValue(bean, "validStart");
					Date validEnd = (Date)ReflectUtil.getValue(bean, "validEnd");
					String supplierId = (String) ReflectUtil.getValue(bean, "supplierId");
					String maintPerson = (String) ReflectUtil.getValue(bean, "maintPerson");
