...
public class HouseAutoTwoTask extends ScheduledTask implements ProjectName {

	private final Logger logger = Logger.getLogger(HouseAutoTwoTask.class);

	private static HouseDailyService houseDailyService = null;
	
	private static String adminName;

	public HouseAutoTwoTask(String name) {
		super(name);
	}
