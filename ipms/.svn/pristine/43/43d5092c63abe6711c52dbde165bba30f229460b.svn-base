  ...
  <body>
   	   <div class="house_info workaccount_edit">
			<form action="" method="post" id="haltplan_submit">
				<div class="house_info workaccount_info">
					<ul class="clearfix" id="stophouse_ul">
						<li><label class="label_name">停售编号</label><input name="logId" type="text" id="logId" class="adroom text_search" readonly></li>
						<li><label class="label_name">民宿编号</label><input name="roomId" type="text" id="roomId" class="adroom text_search" readonly></li>
						<li><label class="label_name">停售类型</label>
							<select name="haltType" id="haltType" class="adroom text_search" disabled="disabled">
								<option value="1">停售</option>
								<option value="2">维修</option>
							</select>
						</li>
						<li><label class="label_name">停售原因</label>
							<select name="haltReason" id="haltReason" class="adroom text_search" disabled="disabled">
						...
						<i class="fa fa-calendar-check-o"></i></li>
						--><li>
							<label class="label_name">停售备注</label>
						...
						<li class="last_li_edit" id="stophouse_last">
		...
		<script type="text/javascript">
			...
			function autosaveRemark(e){
				...
				if(remark){
					$.ajax({
				         url: path + "/autosavestophouseRemarkNew.do",
						 type: "post",
						 data : {
						 	logid : logid,
						 	remark : remark
