    ...
    $.fn.extend({
        select: function (options) {
            ...
            var defaults = {
                ...
                rowColor:"#fff",          //行原本的颜色
                rowHoverColor: "#6A759B", //移动选择时，每一行的hover底色
            ...
            //获取此时列表的高度
            $This.find(".select_list").css("height", opts.listMaxHeight);
            ...
            $This.find(".select_list_body .mCSB_dragger_bar").css({ "background-color": "#6A759B" });
