	...
	$(function($) {
		...
		function changeUrlone(e,type){
			...
			if(type == '1') {
				...
				document.getElementById("st-scroll").innerHTML='<iframe src="' + base_path +'/page/ipmspage/room_statistics/house_forward.jsp" width="100%" height="100%" frameborder=no  scrolling="no"></iframe>'
			}
		...
		function changeUrlthree(e,house){
			...
			if (house == '3') {
				...
				document.getElementById("st-scroll").innerHTML='<iframe src="' + base_path +'/page/ipmspage/apartmentorder/apartmentorder.jsp" width="100%" height="100%" frameborder=no  scrolling="no"></iframe>'
			} else {
		...
		function changeUrleight(e){
			changeimage(e);
			document.getElementById("st-scroll").innerHTML='<iframe src="' + base_path +'/page/ipmspage/houseStatistics/houseStatistics.jsp" width="100%" height="100%" frameborder=no  scrolling="no"></iframe>'
		}
		...
		function houseReportForms(e){
			changeimage(e);
			document.getElementById("st-scroll").innerHTML='<iframe src="' + base_path +'/page/ipmspage/reportform/houseReportForms.jsp" width="100%" height="100%" frameborder=no  scrolling="no"></iframe>'
		}
		function changeIntegral(e,house){
			changeimage(e);
			document.getElementById("st-scroll").innerHTML='<iframe src="' + base_path +'/page/ipmspage/integral/integral.jsp?type='+house+'" width="100%" height="100%" frameborder=no  scrolling="no"></iframe>'
		}
		...
		/*function memberManage(e){
			changeimage(e);
			document.getElementById("st-scroll").innerHTML='<iframe src="' + base_path +'/ipms/WebRoot/page/ipmspage/houseManage/memberManage.jsp" width="100%" height="100%" frameborder=no  scrolling="no"></iframe>'
		}*/
		/*预定入住(合并)*/
		function orderNew(){
			
			JDialog.openWithNoTitle("", base_path + "/checkInByOrder.do",1179,780);
		}
	   ...
	   /* function checkInDirect(){
		...
		function memberSearch(){
			 JDialog.openWithNoTitle("", base_path + "/memberSearch.do",1000,577);
		}
		/*备用金*/
		function pettyCash(){
		...
		function apartmentReserved(){
			...
			JDialog.openWithNoTitle("", base_path + "/reserved.do",1280,825);
		}
...
//		}
        ...
        function memberAddLevel(){
        	JDialog.openWithNoTitle("", base_path + "/payUpGradeMemberLevelInPms.do",700,650);
        }
