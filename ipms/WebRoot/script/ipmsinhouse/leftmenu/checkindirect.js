			...
			showMsg("确认切换为普通房吗?",function(){
				...
				success: function(json) {
					if(json.result=='1'){
						...
						//console.log(json);
						$("#checkuser").val(json.data.ordermemberdata[0].MEMBERNAME);
						$("#rpname").val(json.data.ordermemberdata[0].RPNAME);
						$("#activity").val(json.data.ordermemberdata[0].PRICE);
						$("#memberId").val(json.data.ordermemberdata[0].MEMBERID);
						$("#memberrank").val(json.data.ordermemberdata[0].MEMBERRANK);
						$("#rpId").val(json.data.ordermemberdata[0].RPID);
						$("#rpName").val(json.data.ordermemberdata[0].RPNAME);
						$("#idnumber").val(json.data.ordermemberdata[0].IDCARD);
						$("#discountPerson").val(json.data.ordermemberdata[0].MEMBERID);
						$("#checkuserMain").val(json.data.ordermemberdata[0].MEMBERID);
