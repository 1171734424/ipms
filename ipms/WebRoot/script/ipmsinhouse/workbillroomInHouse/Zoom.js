	 ...
	 _position: function(target){
		...
		switch(true){
			...
			case _config.align == 'top':
				...
				$('.js-max-input',elemParent).css({'position':'absolute','top' :-elemHeight - containerHeight/2,'left':-717});
				break;
			
			case _config.align == 'left':

				$('.js-max-input',elemParent).css({'position':'absolute','top' :0,'left':-717});
				break;
