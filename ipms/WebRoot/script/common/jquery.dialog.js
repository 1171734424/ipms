...
var JDialog = {
	...
	init : function(dialogTitle, iframeSrc, iframeWidth, iframeHeight, fn, isDrag, notitle) {
		...
		$("body").prepend("<div id='jd_dialog' class='ui-jqdialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix fadeInDown'></div>");
		...
		_jd_dialog.css("animation-duration", "0.4s");
		/*_jd_dialog.css("transition-duration", "0.45s");
		_jd_dialog.css("-webkit-animation-duration", "0.4s");*/
		_jd_dialog.append("<div id='jd_dialog_m'></div>");
		var _jd_dialog_m = $("#jd_dialog_m");
		_jd_dialog_m.css("width", iframeWidth + "px");	
		_jd_dialog_m.css("border-radius", "4px");
		...
		_jd_dialog_m_h.css("height", "34px");
		_jd_dialog_m_h.css("line-height", "34px");
		//console.log(projectName)
		_jd_dialog_m_h.append("<span id='jd_dialog_m_h_l'>" + dialogTitle + "</span>");
		_jd_dialog_m_h.append("<img src='"+getRealPath()+"/css/ipms/img/backgroundimg/header_clos.png' class='dialog_img' onclick='JDialog.close()'/>");
		var _dialog_img= $(".dialog_img");
		_dialog_img.css("position", "absolute");
		_dialog_img.css("right", "4px");
		_dialog_img.css("top", "1px");
		...
		_jd_dialog_m_b.css("height",  iframeHeight+'px');      // hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh
		_jd_dialog_m_b.css("background", "#fff");
		_jd_dialog_m_b.css("border-radius", "4px");
		...
		_jd_dialog_m_b_1.css("height", iframeHeight+'px'); //hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh
		_jd_dialog_m_b_1.css("display", "none");
		_jd_dialog_m_b.append("<div id='jd_dialog_m_b_2'></div>");
		var _jd_dialog_m_b_2=$("#jd_dialog_m_b_2");
		/*_jd_dialog_m_b_2.css("background","#fff");*/
		_jd_dialog_m_b_2.css("border-radius","4px");
		...
		if (fn) {
			...
			var btns = $("#btns");
			if (typeof fn == "string") {
				btns.append("<li><div id='sData' style='background-color:#5A5D9D;color:#fff;margin-top:7px;' class='dialogButton'" +
						" onclick='JDialog.ok(\"" + fn + "\");'>" + JDialog.cSubmitText + "</div></li>");
				btns.append("<li><div id='cData' class='dialogButton' style='background-color:#FC8A15;' onclick='JDialog.close();'>"
