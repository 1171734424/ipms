			...
			if(datatype=="房账"){
			  if(((Date.parse(t) - Date.parse(recordtime)) / 3600 / 1000) > 0){
				  showMsg("非当日交接数据不能操作")
			         ...
			         window.parent.parent.JDialog.openWithNoTitle("", path + "/page/ipmspage/room_statistics/roomlist_check.jsp?checkid=" + billid,1179,733); 
			  }
			  ...
			  window.parent.parent.JDialog.openWithNoTitle("", path + "/page/ipmspage/work_account/work_account_check.jsp?workbillid=" +billid,1180,738);
				  }
			}
