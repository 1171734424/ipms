		...
		function changeorder(){
			document.getElementById("ifa").innerHTML='<iframe src="' + base_path +'/page/ipmspage/order/lookorder.jsp?orderId=' +orderId + '&roomid='+ $("#roomid").val() + '&customerid='+ $("#customerid").val() +'" width="100%" height="100%" frameborder=no  scrolling="no"></iframe>'
		}
		/*账单*/
		function changeorderbill(){
			document.getElementById("ifa").innerHTML='<iframe src="' + base_path +'/page/ipmspage/order/bill.jsp?orderId=' +orderId +'" width="100%" height="100%" frameborder=no  scrolling="no"></iframe>'
		}
		/*房租计划*/
		function changeplan(){
			return false;
