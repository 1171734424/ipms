...
<html>
	...
	function consumption() {
		...
		window.parent.JDialog.open("", path + "/page/ipmspage/order/orderConsumption.jsp?strbillid=" + strbillid + "&orderId=" + orderId,680,360);
	}
	...
	function cancleorder() {
		...
		window.parent.JDialog.open("取消订单", path + "/page/ipmspage/order/secondquery.jsp?orderId=" + 
