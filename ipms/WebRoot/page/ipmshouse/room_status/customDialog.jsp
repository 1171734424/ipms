		...
		<script><!--
			...
			function renderDialogGrid() {
				jQuery("#customGrid").jqGrid({
					...
					ondblClickRow: function (rowid, iRow, iCol, e) {
		   				...
		   				window.parent.$("#" + $("#colName").val()).val(rowData[cols[0]]);
		   				window.parent.$("#" + $("#colName").val() + "_CUSTOM_VALUE").val(rowData[cols[1]]);
			...
			function doConfirm() {
				...
				if (shownText && hiddenValue) {
	   				window.parent.$("#" + $("#colName").val()+ "_CUSTOM_VALUE").val(shownText.substring(0, shownText.length - 1));
	   				window.parent.$("#" + $("#colName").val()).val(hiddenValue.substring(0, hiddenValue.length - 1));
	   				window.parent.JDialog.close();
				}
			}
