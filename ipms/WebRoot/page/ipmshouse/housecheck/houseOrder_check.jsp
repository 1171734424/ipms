...
<html>
  ...
  <input type="text" id="customerid" value="<%=request.getParameter("customerid")%>" hidden="true" /> --%>
		...
		<script src="<%=request.getContextPath()%>/script/ipmsinhouse/housecheck/houseOrder_check.js" type="text/javascript" charset="utf-8"></script>
		<script src="<%=request.getContextPath()%>/script/common/tipInfo.js"></script>
	    <script src="<%=request.getContextPath()%>/script/ipmsinhouse/rightclick.js"></script>	
