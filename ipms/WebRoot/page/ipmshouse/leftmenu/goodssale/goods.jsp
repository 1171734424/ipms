...
<html>
  ...
  <div class="check_wrap_margin check_color">
		...
		<div class="shop_content">
		    <iframe name="goodsIframe" id="goodsIframe" frameborder="0" width="100%" height="100%" src="goodsPageInHouse.do"></iframe>
		</div>
		</div>
		...
		<script>
			...
			function goodssale(){
			  $("#goodsIframe").attr("src","goodsPageInHouse.do");
			}
			function goodsmanage(){
			  $("#goodsIframe").attr("src","gdmanageDataInHouse.do");
			}
