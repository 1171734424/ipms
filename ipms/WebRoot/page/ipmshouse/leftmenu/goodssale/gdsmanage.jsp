...
<html>
  ...
  <body class="gdcbody">
		...
		<div class="shop_content">
			...
			<div class="shop_search" style="height:547px;">
				<form action="" method="post" style="height:100%;">
					...
					<iframe name="goodsIframe" id="goodsIframe" frameborder="0" width="100%" height="100%" src="goodsManageInHouse.do" style="height:597px;"></iframe></div>
				</form>
			</div>
		</div>
	</div>
	...
	function gdsearch(){	 
	 ...
	 $("#goodsIframe").attr("src","gdmanageConditionInHouse.do?goodsid="+goodsid+"&goodsname="+goodsname+"&categoryid="+categoryid+"&status="+status);
	}
