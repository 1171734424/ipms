...
<html>
  ...
  <body>
						  ...
						  <li>
							...
							<select id="selectAge" class="text_search" disabled='disabled'>
						        ...
						        <option value="3">操作日志</option>
					         	...
					         	<option value="6">换房日志</option>
					         	<option value="7">门锁日志</option>
						    </select>
						 </li>
						</ul>
		...
		<section class="box-content-section fl" style="width:100%;">
			<section class="box_content_widget fl">
				<div id="integral" class="content" style="height:889px;">
				 ...
				 <c:if test="${param.type == '3'}">
					<iframe name="logFrame" id="logFrame" frameborder="0" width="100%" height="100%" src="houseoperateLog.do?type=<%=request.getParameter("type")%>"></iframe>
				 </c:if>
	...
	<script src="<%=request.getContextPath()%>/script/ipms/js/houseintegral/houseintegral.js"></script>
