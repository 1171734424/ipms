  ...
  <body>
   	<div class="check_wrap_margin check_color">
		...
		<script type="text/javascript">
			...
			function recheckin(){
				JDialog.open("重新入住", path + "/page/ipmspage/room_statistics/recheckin.jsp?checkid=" + checkid, 580, 400);
			}
			...
			function checkout(freshtype){
				...
				JDialog.open("退房", path + "/page/ipmspage/room_statistics/checkout.jsp?checkid=" + checkid + "&freshtype=1&page=" + pagea, 700, 520);
			}
				...
				$.ajax({
					 ...
					 success: function(json) {
					 	if(json.result == 0){
					 		...
					 		window.parent.JDialog.openWithNoTitle("", path + "/page/ipmspage/room_statistics/roomlist_check.jsp?checkid=" + json.data.checkId,1179,733);
					 	}
					 },
					 error: function(json) {}
				});
