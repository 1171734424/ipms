...
<html>
		...
		<div class="apartment" style="display:none;">
			...
			<div class="room_count">
				<table class="table_count"> 
					...
					<tr>
						<th>房间数</th>
						<td id="checkin_count"></td>
						<td id="reserve_count"></td>
						<td id="null_count"></td>
						<td id="stopsale_count"></td>
						<td id="repair_count"></td>
						<td id="demoRoom_count"></td>
						<td id="staffRoom_count"></td>
						<td id="other_count"></td>
					</tr>
	...
	<script src="<%=request.getContextPath()%>/script/apartment/apartmentmainmenu/apartmentroomstatus/room.js"></script>
	<script src="<%=request.getContextPath()%>/script/common/tipInfo.js"></script>	
	<script src="<%=request.getContextPath()%>/script/apartment/apartmentmainmenu/apartmentroomstatus/customer.js"></script>
