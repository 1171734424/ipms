  ...
  <body >
		...
		<form action="" method="post">
			<div class="content_member">
				...
				<div class="content_member_show" style="width: 100%; height:88%;">
					...
					<c:choose>
				   		<c:when test="${loginBranch.branchId == '100001'}">
				   			<iframe id="repairIframe" name="repairIframe" class="" frameborder="0" width="100%" height="100%" src="repairInHouseData.do "></iframe>
				   		</c:when>
				   		<c:otherwise>
					   		<iframe id="repairIframe" name="repairIframe" class="" frameborder="0" width="100%" height="100%" src="repairApartmentData.do "></iframe>
				   		</c:otherwise>
				    </c:choose>
				</div>
			</div>
	...
	<script>
		...
		function addRepairDetail(){
			JDialog.open("添加维修记录",base_path +"/addApartRepairApplication.do",635,350);
		}
