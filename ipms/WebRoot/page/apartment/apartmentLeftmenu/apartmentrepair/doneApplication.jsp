		...
		<form id="workbill_search" action="" method="post">
			...
			<div class="margintop add_repair">
				<ul class="clearfix">
					...
					<li><label class="label_name">维修人员：</label><input id="repairPerson" name="applyname" type="text" class="search_text" value="" />
												<input type="hidden" value="" id="repairPerson_CUSTOM_VALUE" name = "repairPerson__CUSTOM_VALUE">
						
					</li>
					<li><label class="label_name">维修日期：</label><input id="repairDate" name="date" type="text" class="search_text" value="" /></li>
					...
					<li><label class="label_name">问题描述：</label><textarea id="problemdesc" name="problemdesc" type="text" class="search_text area_text" value=""></textarea></li>
