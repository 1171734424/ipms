  ...
  <span class="close_span">
   ...
   <div class="check_wrap_margin check_color">
			...
			<div class="shop_content" style="height:712px;">
			    <iframe name="goodsIframe" id="goodsIframe" frameborder="0" width="100%" height="100%" src="apartmentLoadapply.do"></iframe>
			</div>
	</div>
	<%@ include file="../../../common/script.jsp"%>
	<script src="<%=request.getContextPath()%>/script/common/pager.js"></script>
	<script src="<%=request.getContextPath()%>/script/apartment/js/jquery-1.8.2.min.js" type="text/javascript" charset="utf-8"></script>
	...
	<script src="<%=request.getContextPath()%>/script/common/keyPrevent.js"></script>
	   <script>
			...
			function loadapply(){
			  $("#goodsIframe").attr("src","apartmentLoadapply.do");
			}
			function cleanrecord(){
			  $("#goodsIframe").attr("src","apartLoadcleanrecord.do");
			}
	  </script>
  </body>
</html>
