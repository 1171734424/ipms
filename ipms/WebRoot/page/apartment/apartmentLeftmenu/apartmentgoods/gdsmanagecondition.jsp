...
<html>
  ...
  <body class="gdcbody">
				...
				<tbody id="info" class="gdsmanagebutton">
					<c:forEach items="${gdsmanageCondition}" var="gdsmanageCondition">
						<tr>
							...
							<td id="u${gdsmanageCondition['GOODSID']}" name="gmsdown" class="gdm_hidden"><input name="gdsup" type="button" class="gdsbutton" onclick="goodsup(this)" value="上架"/></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
	...
	<script src="<%=request.getContextPath()%>/script/apartment/apartmentLeftmenu/apartmentgoods/goodsmanage.js"></script>
