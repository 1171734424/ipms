  ...
  <body>
   <!--入账开始 -->
			...
			<div class="high_header">
				<!--  <i class="imooc detail_imooc" style="color:#3B3E40;"></i>	-->
					<div class="margintop">
						<form id="bill_date">
							<ul class="clearfix">
						      <li><label class="label_name">房单号：</label><input name="checkId" type="text" value="${ checkid }" id="id" class="text_edit" readonly></li>
		...
		<script type="text/javascript">
			...
			function onbill(){
				document.getElementById("ontime").innerHTML='<iframe src="' + path +'/page/apartment/apartmentLeftmenu/apartmentrefund/commbill.jsp" width="100%" height="100%" frameborder=no  scrolling="no"></iframe>'
			}
		</script>
  </body>
</html>
