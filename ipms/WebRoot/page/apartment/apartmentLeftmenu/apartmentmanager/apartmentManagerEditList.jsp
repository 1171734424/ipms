...
<html>
  ...
  <body >
	<div class="box_popup_member leftorder_margin">
		...
		<h3>公寓管家管理</h3>
		<form id="pagerForm" name="pagerForm" action="apartmentManagerListInfo.do" method="post" target="reservedFrame">
			<div class="content_member">
				<div class="search_style fl">
					<ul class="search_member clearfix fl">
						<li><label class="label_name">管家姓名:</label><input id="memberName" name="memberName" type="text" class="text_search"></li>
...
<!--						<li><label class="label_name">退款时间:</label><input id="reservedTime" name="reservedTime" type="text" class="date_text text_search" readonly></li>-->
				...
				<div class="content_member_show" style="width: 100%; height:97%;">
					<iframe name="reservedFrame" id="reservedFrame" frameborder="0" width="100%" height="100%" src="apartmentManagerListInfo.do"></iframe>
				</div>
			</div>
		</form>
	</div>
