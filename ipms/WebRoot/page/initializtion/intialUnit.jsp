					...
					<li>
						...
						<ul class="submenu">
						    ...
						    <c:if test="${ branch.branchType == '1' || loginBranch.branchId == '100001'}">
								<li><i class="fa fa-hand-peace-o"></i><a onclick="loadapply()">部门配置</a></li>
								<li><i class="fa fa-folder-open-o"></i><a onclick="cleanrecord()">金柜配置</a></li>
								<li><i class="fa fa-folder-open-o"></i><a onclick="cleanrecord()">房间配置</a></li>
								<li><i class="fa fa-folder-open-o"></i><a onclick="cleanrecord()">房间价配置</a></li>
							</c:if>
							<!-- 公寓的 -->
							...
							<!-- 名宿的 -->
							<c:if test="${ branch.branchType == '3' || loginBranch.branchId == '100001'}">
								<li><i class="fa fa-folder-open-o"></i><a onclick="cleanrecord()">房间价配置</a></li>
							</c:if>
						</ul>
					</li>
