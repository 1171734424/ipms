...
<html>
  ...
  $(function (){
      ...
      var uploader2 = uploadImage({
           ...
           url: base_path+"/cityScenicSpotsPicSave.do?adminiCode="+$("#adminiCode").val(), //图片上传的路径，必须
  ...
  <script type="text/javascript">
  	...
  	function reload(){
  		window.location.href = base_path + "/addScenicSpotsPic.do?adminiCode="+adminiCode+"&citytype=jingdian";
  	}
	...
	function deletePic(e, pictureId){
  		...
  		$.ajax({
	         url: base_path + "/delPicsIndScenic.do",
	         data: {
	        	 pictureId : pictureId,
