...
<html>
  <head>
	...
	<script src="<%=request.getContextPath()%>/script/common/picAdd/uploadImgPreview.js"></script>
		...
		<ul class="img_content">
				  ...
				  <ul class="_filelist">
				  	<c:forEach items="${pictures}" var="p">
					    <li id="${p.pic_id}" class="state-complete dataDel">
					      <img src="${p.pic_url}" style="position: absolute; top: 50%; left: 50%; height:120px; width:240px; margin-top: -60px; margin-left: -120px;">    
			...
			<li>	
				<div class="table_basicInfo">
			  	...
			  	<div class="filled">
				  <ul class="_filelist">
				  	<c:forEach items="${picBedroom}" var="p">
					    <li id="${p.pic_id}" class="state-complete dataDel">
					      <img src="${p.pic_url}" style="position: absolute; top: 50%; left: 50%; height:120px; width:240px; margin-top: -60px; margin-left: -120px;">    
					      <div class="file-panel filedata" style="overflow: hidden; height: 0px;"><span class="cancel" onclick="deletePic(this,'${p.pic_id}')">删除</span></div> 
					    </li>
		    ...
		    <li>	
				<div class="table_basicInfo">
		 			<div id="uploader2" class='uploader2'></div>
				...
				<div class="filled">
			  		<ul class="_filelist">
			  			<c:forEach items="${picLivingroom}" var="p">
				   			 <li id="${p.pic_id}" class="state-complete dataDel">
				     			 <img src="${p.pic_url}" style="position: absolute; top: 50%; left: 50%; height:120px; width:240px; margin-top: -60px; margin-left: -120px;">    
				      			<div class="file-panel filedata" style="overflow: hidden; height: 0px;"><span class="cancel" onclick="deletePic(this,'${p.pic_id}')">删除</span></div> 
				    		</li>
		    ...
		    <li>	
				<div class="table_basicInfo">
		  			<div id="uploader3" class='uploader2'></div>
	       			<div class="choose-file-btn choose_file2" id="choose_file3">选择图片</div>
	        		<button type="button" id="upload_now3" class='upload_now2'>上传图片</button>
				</div>
		
		  	    <div class="filled">
			    	<ul class="_filelist">
			  			<c:forEach items="${reclining}" var="p">
				    		<li id="${p.pic_id}" class="state-complete dataDel">
				     			<img src="${p.pic_url}" style="position: absolute; top: 50%; left: 50%; height:120px; width:240px; margin-top: -60px; margin-left: -120px;">   
				      			<div class="file-panel filedata" style="overflow: hidden; height: 0px;"><span class="cancel" onclick="deletePic(this,'${p.pic_id}')">删除</span></div> 
				    		</li>
		    ...
		    <li>	
				<div class="table_basicInfo">
		  			<div id="uploader4" class='uploader2'></div>
	       			<div class="choose-file-btn choose_file2" id="choose_file4">选择图片</div>
	        		<button type="button" id="upload_now4" class='upload_now2'>上传图片</button>
				</div>
		
			  	<div class="filled">
				  <ul class="_filelist">
				  	<c:forEach items="${pickitchen}" var="p">
					    <li id="${p.pic_id}" class="state-complete dataDel">
					      <img src="${p.pic_url}" style="position: absolute; top: 50%; left: 50%; height:120px; width:240px; margin-top: -60px; margin-left: -120px;">    
					      <div class="file-panel filedata" style="overflow: hidden; height: 0px;"><span class="cancel" onclick="deletePic(this,'${p.pic_id}')">删除</span></div> 
					    </li>
		    ...
		    <li>	
				<div class="table_basicInfo">
				  	<div id="uploader5" class='uploader2'></div>
			       	<div class="choose-file-btn choose_file2" id="choose_file5">选择图片</div>
			        <button type="button" id="upload_now5" class='upload_now2'>上传图片</button>
				</div>
		
			  	<div class="filled">
				  <ul class="_filelist">
				  	<c:forEach items="${pictoilet}" var="p">
					    <li id="${p.pic_id}" class="state-complete dataDel">
					      <img src="${p.pic_url}" style="position: absolute; top: 50%; left: 50%; height:120px; width:240px; margin-top: -60px; margin-left: -120px;">   
					      <div class="file-panel filedata" style="overflow: hidden; height: 0px;"><span class="cancel" onclick="deletePic(this,'${p.pic_id}')">删除</span></div> 
					    </li>
  ...
  $(function (){
      ...
      var uploader2 = uploadImage({
           ...
           url: base_path+"/addBranchHeadPic.do?branchId="+$("#branchId").val()+"&scence="+index, //图片上传的路径，必须
	...
	function deletePic(e, pictureId){
  		...
  		$.ajax({
			 ...
			 success: function(json) {
				 window.location.href = base_path + "/addBranchPic.do?branchId="+$("#branchId").val()+"&scence="+$("#scence").val();
			 },
			 error: function(json) {}
		});
	}
		...
		$('.img_slide').on('click','li',function(){
			...
			$(this).parent().next('ul').children('li:eq('+index+')').show().siblings('li').hide();
			 ...
			 uploader2 = uploadImage({
		           ...
		           multiple: index != '0'? true : false, //是否支持多选能力
		           swf: "http://127.0.0.1:8080/ipms/Uploader.swf", //swf文件路径，必须
		           url: base_path+"/addBranchHeadPic.do?branchId="+$("#branchId").val()+"&scence="+$("#scence").val(), //图片上传的路径，必须
		           maxFileTotalSize: null, //最大上传文件大小，默认10M
