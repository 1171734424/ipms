			...
			<ul class="ul">	
				<li class="li">
					<div class="dialogInput">
						<input id="cond_GROUPID" type="text" placeholder="组合面额"/>
					</div>
				</li>
				<li class="li">
			...
			jQuery(document).ready(function() {
				jQuery("#customGrid").jqGrid({
					...
					ondblClickRow: function (rowid, iRow, iCol, e) {
		   				...
		   				window.parent.$("#tenCoupon").val(rowData["TENCOUPON"]);
		   				window.parent.$("#twentyCoupon").val(rowData["TWENTYCOUPON"]);
		   				window.parent.$("#thirtyCoupon").val(rowData["THIRTYCOUPON"]);
		   				window.parent.$("#fiftyCoupon").val(rowData["FIFTYCOUPON"]);
		   				window.parent.$("#hundredCoupon").val(rowData["HUNDREDCOUPON"]);
