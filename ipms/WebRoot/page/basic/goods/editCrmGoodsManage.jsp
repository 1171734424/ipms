	...
	<form name="myFrom" id="myForm" class="ctdform">
		<table class="ptable crm-table" border="0" cellspacing="0"
			...
			<tbody>
		     ...
		     <col width="2%"> -->
		     	<tr>
					<td><input id="goodsId" name="goodsId" type="hidden" value="${goodsId }"/></td>
				</tr>
				<tr>
					<td class="ctdtitle notnull" align="center">商品名称</td>
					<td align="left" class="pinputtd"><input type="text"
						id="goodsName" class="ptdinput" maxlength="15" value="${goodsName }"/></td>
				...
				<tr>
					...
					<td align="left" class="pinputtd"><input
						...
						class="ptdinput" type="hidden" value="${gc.categoryId }" /> <input
						id="categoryId_select" name="categoryId_select" class="ptdinput"
						type="text" value="${categoryId }" readonly="true" /></td>
					<td class="ctdtitle"></td>
					<td class="ctdtitle"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="left" class="pinputtd"><input
						...
						class="ptdinput" type="hidden" value="${gc.supplierId }" /> <input
						id="supplierId_select" name="supplierId_select" class="ptdinput"
						type="text" value="${supplierId }" readonly="true" /></td>
					<td class="ctdtitle"></td>
					<td class="ctdtitle"></td>
				</tr>
				<tr>
					...
					<td align="left" class="pinputtd"><input type="text"
						id="price" class="ptdinput" value="${price }"/></td>
					<td class="ctdtitle"></td>
					<td class="ctdtitle"></td>
				</tr>
				<tr>
					...
					<td align="left" class="pinputtd"><input type="text"
						id="specifications" class="ptdinput" maxlength="4" value="${specifications }"/></td>
					<td class="ctdtitle"></td>
					<td class="ctdtitle"></td>
				</tr>
				<tr>
					...
					<td align="left" class="pinputtd"><input type="text"
						id="unit" class="ptdinput" maxlength="4" value="${unit }"/></td>
					<td class="ctdtitle"></td>
					<td class="ctdtitle"></td>
				</tr>
				<tr>
					...
					<td align="left" class="pinputtd"><input
						...
						class="ptdinput" type="hidden" value="${gc.saleType }" /> <input
						id="saleType_select" name="saleType_select" class="ptdinput"
						type="text" value="${saleType }" readonly="true" /></td>
					<td class="ctdtitle"></td>
					<td class="ctdtitle"></td>
				</tr>
				<tr>
					...
					<td align="left" class="pinputtd"><input
						...
						class="ptdinput" type="hidden" value="${gc.status }" /> <input
						id="status_select" name="status_select" class="ptdinput"
						type="text" value="${status }" readonly="true" /></td>
					<td class="ctdtitle"></td>
					<td class="ctdtitle"></td>
				</tr>
				<tr>
					...
					<td align="left" class="pinputtd"><input type="text"
						id="productionDate" class="ptdinput" maxlength="100" value="${productionDate }"/></td>
					<td class="ctdtitle"></td>
					<td class="ctdtitle"></td>
				</tr>
				<tr>
					...
					<td align="left" class="pinputtd"><input type="text"
						id="integral" class="ptdinput" value="${integral }" onKeyUp="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" maxlength="6"/></td>
					<td class="ctdtitle"></td>
					<td class="ctdtitle"></td>
				</tr>
				<tr>
...
<script type="text/javascript">
	...
	function goodsMangerAdd() {
		...
		$.ajax({
			url : base_path + "/saveEditCrmGoodsManage.do",
			type : "post",
			dataType : "json",
			data : {
				'goodsName' : goodsName,
