		     ...
		     <col width="2%"> -->
				<tr>
					...
					<td align="left" class="pinputtd"><input type="text"
						id="categoryName" class="ptdinput" maxlength="5" /></td>
				...
				<tr>
					...
					<td align="left" class="pinputtd"><input
						...
						type="hidden" value="" /> <input id="superCategory_select"
						name="superCategory_select" class="ptdinput" type="text" value=""
						readonly="true" /></td>
					<td class="ctdtitle"></td>
					<td class="ctdtitle"></td>
				</tr>
...
<script type="text/javascript">
	...
	function goodsTypeAdd() {
		...
		$.ajax({
			url : base_path + "/saveCrmGoodsType.do",
			type : "post",
			dataType : "json",
			data : {
