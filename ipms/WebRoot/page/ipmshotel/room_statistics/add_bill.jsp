						...
						<form id="bill_date">
							<ul class="clearfix">
						      ...
						      <li style="position:relative;">
							      ...
							      <input id="project" name="project" type="text" value="" class="text_edit margin_text" onclick="onbill()" readonly>
						      ...
						      <li><label class="label_name">备注：</label> <textarea name="remark" cols="100" rols="10"></textarea></li>
