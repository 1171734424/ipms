  ...
  <body>
      ...
      <div class="header_roomlist">
			<ul>
				...
				<li class="header_roomlist_li" onclick="getOutuncheckin()">
					<span>已退未结房单</span>
				</li>
			</ul>
			<div class="fr">
			...
			<div class="high_header fadeIndown">
				...
				<form id="room_search" action="" method="post">
					<div class="margintop">
						...
						<ul class="clearfix">
							<li><input type="button" style="margin-right: 12px;" value="重置" class="button_margin reset" onclick="resetsearch()">
							</li>
	 ...
	 <script src="<%=request.getContextPath()%>/script/common/keyPrevent.js"></script>
		<script type="text/javascript">
			...
			function getOutuncheckin(){
				$("#logFrame").attr("src","<%=request.getContextPath()%>/showroomlistcheckdata.do?status=3");
			}
			
			function getQueryData(){
				$(".header_roomlist li").removeClass("active");
