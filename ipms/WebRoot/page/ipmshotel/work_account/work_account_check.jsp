...
<html>
  ...
  <body>
		...
		<script type="text/javascript">
			...
			/*账单*/
			function changetwo() {
				document.getElementById("a").innerHTML = '<iframe src="<%=request.getContextPath()%>/page/ipmshotel/work_account/work_bill.jsp?workbillid=' + workbillid + '" width="100%" height="100%" frameborder=no  scrolling="no"></iframe>'
			}
			/*日志*/
			function changefive() {
				document.getElementById("d").innerHTML = '<iframe src="' + path +'/page/ipmshotel/room_statistics/log.jsp?type=workbill&checkid='+ workbillid + '" width="100%" height="100%" frameborder=no  scrolling="no"></iframe>'
