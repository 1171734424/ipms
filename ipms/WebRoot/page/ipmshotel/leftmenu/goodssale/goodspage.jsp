  ...
  <body style="overflow: hidden;">
    <div class="check_wrap_margin check_color">
		<div class="shop_content  margin_gdspage">
			<h2>小商品售卖</h2>
			<div class="shop_search" style="height:550px; overflow:scroll">
				<form action="" method="post">
					...
					<iframe name="goodsIframe" id="goodsIframe" frameborder="0" width="100%" height="100%" src="hotelgdsaleCondition.do" class="gpageiframe"></iframe>
					</div>
				</form>
			</div>
		</div>
	<div id="pager"></div>
		...
		<script src="<%=request.getContextPath()%>/script/ipmshotel/leftmenu/goodssale/goodssale.js"></script>
		...
		function gdsearch(){
		 ...
		 $("#goodsIframe").attr("src","hotelgdsaleCondition.do?goodsid="+goodsid+"&goodsname="+goodsname+"&categoryid="+categoryid+"&gdscontent="+gdscontent);
		}
