...
<html>
  ...
  <body >
		<div class="order_margin col_margin" >
			...
			<div class="content_member_show" style="width: 100%; height: 92%;">
				<iframe id="orderIframe" name="orderIframe" class="" frameborder="0" width="100%" height="100%" src="hotelorderNew.do"></iframe>
			</div>
		</div>
	...
	<script>
		...
		$(function(){
	  	...
	  	function orderNew(e){
	  		$("#orderIframe").attr("src","hotelorderNew.do");
	  		
	  	}
	  	
	  	function checkIn(e){
	  		if(RoomType != null){
	  			$("#orderIframe").attr("src","hotelcheckInDirect.do?roomId=" + RoomId + "&roomType=" + RoomType);
	  			$(".secod_li").addClass("active");
				$(".secod_li").siblings().removeClass("active");
	  		}else{
	  			$("#orderIframe").attr("src","hotelcheckInDirect.do");
	  		}
	  	}
