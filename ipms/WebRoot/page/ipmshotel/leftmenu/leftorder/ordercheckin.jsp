	  ...
	  <form action="" method="post">
		 ...
		 $(document).ready(function(){
		  $("#paymethod").children('input[type=checkbox]').click(function(){
            ...
            $("#score").bind("click",function(){
			  ...
			  if(MemberId){
		      JDialog.open("", base_path + "/hotelscoreExchange.do?MemberId=" + MemberId + "&sjscore="+sjscore, 600, 410);
		      }else{
		...
		function showMsg(msg, fn) {
					...
					if (1 == json.result) {
					    if(json.message){
					        showMsg(json.message);
					         ...
					         JDialog.open("", base_path + "/hoteljudgeUser.do?Mnumber="+Mnumber,300,150);
					       }
			...
			$("#roomid").bind("click",function(){
			  ...
			  if(roomtype){
		      JDialog.open("", base_path + "/hotelroomSelect.do?roomtype=" + roomtype+"&theme=" + theme+"&roomacount="+roomacount, 800, 410);
		      }else{
		      showMsg("请先选择房间类型！");
		      }
			})
