			...
			<ul class="ul">
				<li class="li">
					<div class="dialogInput" id="CDialog" style="width: 258px;">
						<input id="cond_CUSTOMVALUE" type="text" placeholder="名称"/>
					</div>
				</li>	
			...
			function renderDialogGrid() {
				jQuery("#customGrid").jqGrid({
					...
					ondblClickRow: function (rowid, iRow, iCol, e) {
		   				...
		   				$.ajax({
		   					url : "selectRoomtype4RoomAdd.do",
		   					type : "post",
		   					dataType : "json",
		   					//async:false,
		   					data : {
		   						 
		   						'branchid' : rowData[cols[0]]
		   					...
		   					success : function(json) {
		   						if (1 == json.result) {
		   							var tabledata = "<option value=''>-未选择调价规则-</option>";
		   					  		...
		   					  		tabledata = tabledata + "<option value='" +json.data[index]['ROOMTYPE']
		   					  		+"'>" +json.data[index]['ROOMNAME'] + "</option>";
		   					  		
		   					  		
		   					  		});
		   					  	$(window.parent.document).find("#rproomtype").html(tabledata);
		   						} 
