...
<html style="width: 100%; height: inherit;">
	...
	<body oncontextmenu="return true;">
		...
		<input type="hidden" name="dataEvent" id="dataEvent" value='${dataEvent}'/>
		...
		<script><!--
			...
			function loadUrl() {
				return "loadlinkageDialogData.do?dialogTarget=" + $("#dialogTarget").val()
					...
					+ "&dataEvent=" + encodeURIComponent($("#dataEvent").val()) + "&event=" + $("#event").val();
			}
			
			function queryCustomDialogData() {
				if (selectType == "dialog") {
