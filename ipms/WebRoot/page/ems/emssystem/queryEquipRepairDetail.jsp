					...
					<div class="wrapper">
						<div class="inputArea" style="margin-top:1.5%;">
							<select id="cond_STATUS">
							    ...
							    <option value="已删除" style="font-size:15px;">已删除</option>
		...
		<script>
			...
			jQuery(document).ready(function() {
				jQuery("#customGrid").jqGrid({
					url: "queryEquipRepairInDetail.do?serialNo="+serialNo,
					datatype: "json",
			...
			function setGridModels() {
				return [
				{name: 'REPAIRAPPLYID', index: 'REPAIRAPPLYID', width:40, align:"center" },
			...
			function queryCustomDialogData() {
				var query_url = "queryEquipRepairInDetail.do?serialNo=" +serialNo+ "&queryTimeStart="+$('#cond_TIMESTART').val()+"&queryTimeEnd="+$('#cond_TIMEEND').val()+"&queryStatus="+$('#cond_STATUS').val();
