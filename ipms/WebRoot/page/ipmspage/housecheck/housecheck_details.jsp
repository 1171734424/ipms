  ...
  <body>
   	<div class="detail_wrap_margin detail_color">
		...
		<script>
			...
			function overstay(){
				if(checkDo == 1){
					window.JDialog.open("续住", path + "/page/ipmspage/housecheck/overstay.jsp?leavetime=" + $("#leavetime").val() + "&houseorderid=" + houseorderid, 610, 330);
				}
			}
			...
			function adjustprice(){
				if(checkDo == 1){
					window.JDialog.open("价格调整", base_path + "/adjustorderprice.do?orderid=" + houseorderid, 420, 180);
				}				
				...
				$.ajax({
					 ...
					 success: function(json) {
					 	if (json.result == 0) { 
					 		...
					 		window.JDialog.open("民宿退房", path + "/page/ipmspage/housecheck/secondquery.jsp?orderId=" + houseorderid , 300,370);
					 	}	
					 }
				});
				/* $.ajax({
		...
		function lookHouseOrder(){                            
			window.parent.JDialog.openWithNoTitle("", path + "/page/ipmspage/housecheck/houseOrder_check.jsp?houseorderid=" + houseorderid , 1179, 733);
		}
	</script>
  </body>
</html>
